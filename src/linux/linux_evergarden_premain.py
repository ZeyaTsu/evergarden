...
import sys, requests, datetime, os, getpass
...
try:
    ...
    module_path = f"{home_directory}/Evergarden/linux_EvergardenLoader.py"

    # Load the module using importlib
    spec = importlib.util.spec_from_file_location("linux_EvergardenLoader.py", module_path)
